...
function draw() {
 ...
 background("pink");
  ...
  var IncreseSpeedOfBird=bird.position.x/1500;
...
function spawnpillar(){
  ...
  if(bird.position.x%100===0){
     if(rand===1){
        pillar = createSprite(bird.position.x+600,290,20,20);
    ...
    if(rand===2){
        ...
        pillar1 = createSprite(bird.position.x+600,500,20,20);
...
function bombspawn(){
     ...
     if (bird.position.x%330===0){
         if(rand===1){
            ...
            bomb=createSprite(bird.position.x+600,0,20,20);
     ...
     if (rand===2){
         ...
         lazer=createSprite(bird.position.x+600,0,20,20);
...
function spawnheart(){
    ...
    if (bird.position.x%750===0){
        heart=createSprite(bird.position.x+600,600,20,20);
